  ...
  "targets": [
    {
      ...
      "placement": {
        "display": "below",
        "mountSelector": "main",
        "commentsBackgroundColor": "#1b1f27" // optional
      }
    }
  ]
}
...
- [Profiles pack](https://github.com/HayamiKomento/komentoscript-pages/blob/master/examples/komentoscript-examples/profiles.pack.json)
...
You can also _validate_ that your files fit the schema by `npm run build` . If there are any errors, such as trying to put custom website configurations into KomentoScript without considering the syntax:
