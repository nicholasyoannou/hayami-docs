...
Open up Ollama again, and choose whatever model you prefer. In this example, I'll be using "llama3.2:3b-instruct-q4\_0" which uses CPU resources (instead of GPU), is more-lightweight, and gets the job done for analyzing HTML. Pop a message "hi" to test that works.
