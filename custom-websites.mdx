...
Hayami has support for [some websites](/getting-started) out-of-the-box, but due to the plethora of rapidly-growing online forums, communities, and anime streaming websites globally, Hayami may not support _everything_ at once. But, with custom websites, any site can support Hayami, setup by you. If you want a GIF instead of a wiki-style guide, an example is below for your convenience.
