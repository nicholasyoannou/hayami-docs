...
Hayami has support for [some websites](/getting-started#all-done-from-there) out-of-the-box, but due to the plethora of rapidly-growing online forums, communities, and anime streaming websites globally, Hayami may not support _everything_ at once. But, with custom websites, any site can support Hayami, setup by you. If you want a GIF instead of a wiki-style guide, an example is below for your convenience.
...
<Steps>
  ...
  <Step title="Merge all of these site mapping files into a single one using Hayami's site merger.">
    ...
    If you've already got your exported JSON, the importer also supports expanding your existing mapping, so you can import that file in-future to expand it if desired, if your editing your gist.
